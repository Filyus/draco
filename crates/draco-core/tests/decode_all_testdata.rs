...
const EXPECTED: &[(&str, usize, usize)] = &[
    ...
    ("car.drc", 1856, 1744),
    ("cube_att_sub_o_2.drc", 8, 12),
    ("cube_att_sub_o_no_metadata.drc", 8, 12),
    ("cube_att.drc", 8, 12),
    ("cube_att.obj.edgebreaker.cl10.2.2.drc", 8, 12),
    ("cube_att.obj.edgebreaker.cl4.2.2.drc", 24, 12),
    ("cube_att.obj.sequential.cl3.2.2.drc", 24, 12),
    ("cube_pc.drc", 24, 0),
    ("grid5x5_cpp.drc", 25, 32),
    ("lamp_cpp_std.drc", 6266, 12082),
    ("ngon12.drc", 12, 10),
    ("octagon_preserved.drc", 8, 6),
    ("pc_color.drc", 7733, 0),
