...
// Transcoder compression options moved to draco_io
...
// Copies all data from the |src| point cloud.
  ...
  // Returns the attribute of a given type and name.
...
// Compression-related methods moved to draco_io (transcoder functionality)
...
// Compression member variables moved to draco_io (transcoder functionality)
