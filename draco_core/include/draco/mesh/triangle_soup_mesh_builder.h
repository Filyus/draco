...
// SetName functionality moved to draco_io (transcoder functionality)
...
// ConvertAndSetAttributeValuesForFace moved to draco_io (transcoder functionality)
...
// ConvertAndSetAttributeValuesForFace template implementation moved to draco_io (transcoder functionality)
